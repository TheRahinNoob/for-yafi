          ...
          <div className="flex items-center gap-x-3 px-4 py-[10px] rounded-2xl hover:bg-[#3c4043] text-[#dadce0] cursor-pointer">
            ...
            >
              <path
                ...
                d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2"
              />
            </svg>
            <span>Computers</span>
          </div>
          ...
          <div className="flex items-center gap-x-3 px-4 py-[10px] rounded-2xl hover:bg-[#3c4043] text-[#dadce0] cursor-pointer">
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M19 7l-.595 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.595-1.858L5 7m5 4v6m4-6v6m1-10V9a1 1 0 00-1-1h-4a1 1 0 00-1 1v1M12 4v-1a1 1 0 00-1-1H9a1 1 0 00-1 1v1"
              />
            </svg>
            <span>Trash</span>
          </div>
            ...
            <button className="p-2 rounded-full hover:bg-[#3c4043] text-[#dadce0]">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M4 6a2 2 0 012-2 2 2 0 01-2-2 2 2 0 01-2-2 2 2 0 012-2 2 2 0 01-2-2 2 2 0 012-2zm2 2a2 2 0 012-2 2 2 0 01-2-2 2 2 0 01-2-2 2 2 0 012-2zm2 2a2 2 0 012-2 2 2 0 01-2-2 2 2 0 01-2-2 2 2 0 012-2zm2 2a2 2 0 012-2 2 2 0 01-2-2 2 2 0 01-2-2 2 2 0 012-2z"
                />
              </svg>
            </button>
            ...
            <button className="p-2 rounded-full hover:bg-[#3c4043] text-[#dadce0] relative">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 00-9-5.197V8.5m.002 3.5L12 14l-4.998-3.5"
                />
              </svg>
              ...
              <button className="flex items-center justify-center w-9 h-9 rounded-3xl bg-[#3c4043] text-[#8ab4f8]">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M4 6a2 2 0 012-2 2 2 0 01-2-2 2 2 0 01-2-2 2 2 0 012-2zM4 12a2 2 0 012-2 2 2 0 01-2-2 2 2 0 01-2-2 2 2 0 012-2zM4 18a2 2 0 012-2 2 2 0 01-2-2 2 2 0 01-2-2 2 2 0 012-2z"
                  />
                </svg>
              </button>
